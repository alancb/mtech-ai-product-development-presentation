...
export const metadata: Metadata = {
  ...
  title: 'Building for the Way Work Works Now | MTECH',
  description: 'A vision for AI Product Development education at MTECH.',
  openGraph: {
    title: 'Building for the Way Work Works Now',
    description: 'A shared foundation for AI-powered product teams — and a new model for technical education.',
    type: 'website',
    images: [{ url: '/og.png', width: 1200, height: 630, alt: 'Building for the way work works now.' }],
  },
  twitter: {
